...
if (typeof window !== "undefined" && window !== null) {
  window.SUPTWEEN = require('../lib/sup-tween.js');
}
...
},{"../lib/sup-tween.js":2}],2:[function(require,module,exports){
/**
...
SUPTWEEN.Tween = function ( object ) {
  ...
  */
  ...
  this.update = function ( time ) {
    if (this.test) console.log("update tweener", time, _startTime);
    if ( _isPaused === true ) {
